 ...
 */
public class BackStopTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testBackStop(){
        ...
        onView(withId(R.id.timerFragment)).perform(click(pressBack()));
        timer.check(ViewAssertions.matches(withText("00.000")));
    }
}
