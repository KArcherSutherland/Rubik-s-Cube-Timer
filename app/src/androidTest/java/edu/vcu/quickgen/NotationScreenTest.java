 ...
 * Test for Happy Path:  Navigate to the notation guide screen - Notation Guide
 */
...
public class NotationScreenTest extends
        ActivityInstrumentationTestCase2<MainActivity>{

    public NotationScreenTest() {
    ...
    public void testTimerStarted() throws InterruptedException {
        ...
        onView(withId(R.id.textGuide)).check(matches(isDisplayed()));
    }
