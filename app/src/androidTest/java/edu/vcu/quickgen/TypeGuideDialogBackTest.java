 ...
 * Test for Sad Path: Back Exit Guide - Rubik's Cube Type Guide
 */
public class TypeGuideDialogBackTest extends
        ActivityInstrumentationTestCase2<MainActivity> {

    public TypeGuideDialogBackTest() {
    ...
    public void testTimerStarted() throws InterruptedException {
        ...
        SystemClock.sleep(2000);
        onView(withText("2x2")).perform(ViewActions.pressBack());
        SystemClock.sleep(2000);
        onView(withText("2x2")).check(matches(isDisplayed()));
    }
}
